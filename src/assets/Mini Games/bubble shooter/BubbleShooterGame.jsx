    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <WebView
          ref={webViewRef}
          originWhitelist={['*']}
          source={{ html: bubbleHtml, baseUrl: 'http://localhost/' }}
          ...
          onMessage={(event) => {
            try {
              ...
              if (data.type === 'error') {
                console.log("BUBBLE SHOOTER WEBVIEW ERROR:", data.message);
...
const styles = StyleSheet.create({
  safeArea: {
    flex: 1,
    backgroundColor: '#1e1e2f', // Match bubble shooter background
  },
  container: {
    flex: 1,
    overflow: 'hidden',
