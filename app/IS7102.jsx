...
export default function CourseScreen() {
  ...
  const courseId = id || '63';
  const targetCode = 'IS7102';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          title: "IT Law",
          code: "IS7102",
          description: "IT Law - Cyber Law • Regulations • Policy (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS7102' } }) }} />
