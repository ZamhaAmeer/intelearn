...
export default function CourseScreen() {
  ...
  const courseId = id || '51';
  const targetCode = 'IS5105';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          code: "IS5105",
          description: "Business Process Management - Workflows • Modeling • Optimization (2 Credits)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS5105' } }) }} />
