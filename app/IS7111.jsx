...
export default function CourseScreen() {
  ...
  const courseId = id || '72';
  const targetCode = 'IS7111';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          code: "IS7111",
          description: "Advanced Programming Practicum - Optimization • Problem Solving (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS7111' } }) }} />
