...
export default function CourseScreen() {
  ...
  const courseId = id || '55';
  const targetCode = 'IS5109';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 55,
          title: "IS Project for Community",
          code: "IS5109",
          description: "IS Project for Community - Social Impact • Real-world Sol (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS5109' } }) }} />
