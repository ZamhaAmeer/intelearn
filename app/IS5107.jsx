...
export default function CourseScreen() {
  ...
  const courseId = id || '53';
  const targetCode = 'IS5107';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 53,
          title: "Project Management Practicum",
          code: "IS5107",
          description: "Project Management Practicum - Scheduling • Resources • Execution (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS5107' } }) }} />
