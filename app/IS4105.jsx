...
export default function CourseScreen() {
  ...
  const courseId = id || '40';
  const targetCode = 'IS4105';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 40,
          title: "IT Procurement Management",
          code: "IS4105",
          description: "IT Procurement Management - Contracts • Tenders • Sourcing (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS4105' } }) }} />
