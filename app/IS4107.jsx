...
export default function CourseScreen() {
  ...
  const courseId = id || '42';
  const targetCode = 'IS4107';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 42,
          title: "Professionalism & Ethics in Computing",
          code: "IS4107",
          description: "Professionalism & Ethics in Computing - Code of Conduct • Ethics (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS4107' } }) }} />
