...
export default function CourseScreen() {
  ...
  const courseId = id || '69';
  const targetCode = 'IS7108';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 69,
          title: "Web Service Technologies",
          code: "IS7108",
          description: "Web Service Technologies - REST • SOAP • APIs (2 Credits)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS7108' } }) }} />
