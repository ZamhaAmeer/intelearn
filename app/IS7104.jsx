...
export default function CourseScreen() {
  ...
  const courseId = id || '65';
  const targetCode = 'IS7104';
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          id: 65,
          title: "Enterprise Modelling Ontologies",
          code: "IS7104",
          description: "Enterprise Modelling Ontologies - Semantic Web • Knowledge Representation (2 Credits)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS7104' } }) }} />
