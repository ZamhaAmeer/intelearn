...
export default function CourseScreen() {
  ...
  const courseId = id || '39';
  const targetCode = 'IS4104';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          code: "IS4104",
          description: "System Administration and Maintenance - Linux • Scripts • Infrastructure (2 Credits)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS4104' } }) }} />
