...
export default function CourseScreen() {
  ...
  const courseId = id || '78';
  const targetCode = 'IS8105';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          title: "IS Economics",
          code: "IS8105",
          description: "IS Economics - Markets • Tech Value • Investment (2 Credits)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS8105' } }) }} />
