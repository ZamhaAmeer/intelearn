...
export default function CourseScreen() {
  ...
  const courseId = id || '43';
  const targetCode = 'IS4108';
    ...
    const fetchCourseData = async () => {
      try {
        ...
        setCourseData({
          ...
          title: "IS Strategies",
          code: "IS4108",
          description: "IS Strategies - Alignment • Business Goals • Planning (1 Credit)",
          materials: []
        });
      } finally {
        setLoading(false);
        ...
        <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={toggleMenu}>
          <View style={[styles.sideMenu, isDark && { backgroundColor: '#1A1A1A' }]}>
            ...
            <View style={styles.menuList}>
              ...
              <MenuOption iconName="folder-open" title="Shared Notes" onPress={() => { setMenuVisible(false); router.push({ pathname: '/student_notes', params: { courseCode: courseData?.code || 'IS4108' } }) }} />
